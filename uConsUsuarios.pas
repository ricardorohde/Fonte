...
uses uMenu, uDetalheUsuario, uDetalheCadastroUsuario, uLogin, Funcao_DB;
...
{  frmDetalheUsuario:= tfrmDetalheUsuario.Create(self);
  ...
  frmDetalheCadastroUsuario:= tfrmDetalheCadastroUsuario.Create(self);
  frmDetalheCadastroUsuario.ShowModal;
  frmDetalheCadastroUsuario.Free;
  qrConsulta.Refresh;
